...
class ClientTest(unittest.TestCase):
  ...
  def test_getDataPoint_calculatePriceAskAndBidEqual(self):
    quotes = [
  ...
  def test_getRatio_calculateRatioPriceAAndBZero(self):
    price_a = 0
    price_b = 0
    """ ------------ Add the assertion below ------------ """
    self.assertIsNone(getRatio(price_a, price_b))

  def test_getRatio_calculateRatioPriceAAndBEqual(self):
    price_a = 121.2
    price_b = 121.2
    """ ------------ Add the assertion below ------------ """
